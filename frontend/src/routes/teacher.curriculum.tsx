...
function defaultDraft(): DraftState {
  return {
    lessonId: "",
    subjectId: "",
    subjectTitle: "Computer Science Foundations",
    subjectDescription: "Structured lessons before formal coding.",
    courseId: "",
    courseTitle: "Before Coding",
    courseDescription: "A teacher-authored path for thinking like a computer before syntax.",
    unitId: "",
    unitTitle: "Instructions And Meaning",
    unitPosition: "1",
    lessonTitle: "What Is An Instruction?",
    lessonLevel: "Any level",
    lessonType: "discussion",
    tutorPrompt:
      "Guide the student to understand that an instruction is a clear action someone or something can follow. Keep the conversation short, concrete, and age-aware.",
    sampleCode: "",
    milestoneTitle: "Explain A Clear Instruction",
    milestoneObjective:
      "The student can describe what makes an instruction clear and give one everyday example.",
    skillKeys: "cs.instructions,logic.clarity",
    allowedModes: ["text"],
    activityTitle: "Instruction discussion",
    activityStage: "practice",
    activityPrompt:
      "Tell me one instruction you followed today. What made it clear enough to follow?",
    activityResponseMode: "text",
    starterCode: "",
    expectedOutput: "",
    rubricNotes:
      "Pass when the student gives an example and explains why the instruction is clear.",
    quizPrompt: "Which instruction is clearest?",
    quizChoices: [
      { id: "a", text: "Do the thing." },
      { id: "b", text: "Put your notebook in your bag." },
      { id: "c", text: "Handle it later." },
    ],
