...
// (the Calendar tab inside the ClassesModal). Fed by fetchStudentGrades (checkpoint_recipients +
// checkpoints, self-scoped by RLS), which carries due_at + submitted_at per unified work item.
...
export function StudentCalendarBody({
  ...
  if (grades === null) return <StateNote>Loading your calendar…</StateNote>;
